...
public enum WebSlideTemplates {
    ...
    private static let songPreset = Preset(
        ...
        hint: "Смотрите «сохранять переносы строк»: в куплете строки стоят там, где их поставил автор. Выключите — и куплет склеится в одну строку через разделитель, как на страницах VisioBible.",
        values: [
            ("--sl-song-title", "block"),
            ("--sl-title-scale", "0.5"),
            ("--sl-page", "block"),
