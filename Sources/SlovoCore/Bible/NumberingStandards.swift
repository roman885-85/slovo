...
public struct NumberingAssignment: Sendable, Hashable {
    ...
    public enum Source: String, Sendable, Hashable {
        ...
        case author     // таблиця `modules` з бази VisioBible
...
///
/// Таблиця `modules` у базі VisioBible описує вісім перекладів із
...
/// в базі VisioBible: база чужа, вона всередині чужого застосунку і може бути
