...
/// в VisioBible служат подписи, вшитые в формы Delphi; у нас их взять неоткуда,
...
final class LocalizeTranslateModel: ObservableObject {
    ...
    enum DeleteRefusal {
        ...
        case inUse
        /// Это файл из папки VisioBible: чужую установку на запись не трогаем.
        case notOurs
    }
