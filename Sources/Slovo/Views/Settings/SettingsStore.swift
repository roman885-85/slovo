...
final class SettingsStore: ObservableObject {
    ...
    /// вісімдесят імен старої програми), — геть; пісенник, що став `.songbook`, —
    ...
    /// (35) «По умолчанию» — раскладка поставки прежней программы V2.5.
...
extension AppState {
    ...
    /// раскладывает фоны и сама прежняя программа.
    ///
