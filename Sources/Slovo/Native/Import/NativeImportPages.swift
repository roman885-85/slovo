...
final class ImportIntroPage: NSView, ImportPageRefreshing {
    ...
    init(state: AppState, model: ImportWizardModel) {
        ...
        let ours = ImportText(OurWords.t("Источником может быть папка с данными прежней программы или любая папка, архив .zip либо файл: "
            ...
            + "песенники в старом формате (.vbm) и «Слова» (.songbook); шаблоны слайда (папка Templates, .sch); "
