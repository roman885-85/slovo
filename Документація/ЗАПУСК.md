...
Повністю повідомлення таке: «Програму «Слово» пошкоджено, її не можна
відкрити. Потрібно перенести її у Смітник». Програма ціла: так macOS
...
it to the Trash.” The app is fine: this is how macOS reacts to the “downloaded from the
